...
middleware['i18n'] = async ({ app, req, res, route, store, redirect, isHMR }) => {
  ...
  const locales = getLocaleCodes([{"code":"en","iso":"en-US","name":"English","file":"en.js"},{"code":"de","iso":"de-DE","name":"Deutsch","file":"de.js"}])
  ...
  const detectBrowserLanguage = {"useCookie":true,"cookieKey":"redirected","alwaysRedirect":"","fallbackLocale":null}
